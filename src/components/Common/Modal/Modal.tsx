...
const Modal = ({
  ...
  return (
    ...
    >
      <div className="min-w-[936px] min-h-[410px] fixed top-1/2 left-1/2 -translate-x-2/4 -translate-y-2/4 bg-white px-[50px] pt-[36px] pb-[53px] rounded-xl flex flex-col">
